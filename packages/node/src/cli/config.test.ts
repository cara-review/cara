// The config matrix (TN-26-026): no config is a loud paste-ready error; mode validation
// is strict; the [llm] block is required for mode "llm" and optional for "git-order";
// the key is stored only by env-var NAME, never its value.
