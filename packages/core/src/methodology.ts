...
export const SYSTEM_METHODOLOGY: string = [
  ...
  "",
  "Give every Chapter and Section a one-line summary — required.",
  "",
  ...
  "is a comment on a change. A FINDING THAT IS NOT A COMMENT DOES NOT EXIST: the engine",
  "cannot see prose, only comments. Comment first, narrate after.",
  "",
